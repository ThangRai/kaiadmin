                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="form-header d-flex justify-content-end">
                                                <button type="submit" name="<?php echo $edit_service ? 'edit_service' : 'add_service'; ?>" class="btn btn-primary">
                                                    <i class="fas fa-save"></i> Lưu
                                                </button>
                                                <a href="service.php" class="btn btn-secondary ml-2">
                                                ...
                                                <tbody>
                                                    <?php foreach ($services as $service): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="?method=frm&edit_id=<?php echo $service['id']; ?>" class="btn btn-sm btn-warning" title="Sửa">
                                                                    <i class="fas fa-edit"></i> Sửa
                                                                </a>
                                                                <a href="?delete_id=<?php echo $service['id']; ?>" class="btn btn-sm btn-danger" title="Xóa" onclick="return confirm('Bạn có chắc muốn xóa?')">
