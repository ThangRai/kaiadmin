                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="form-header d-flex justify-content-end">
                                                <button type="submit" name="<?php echo $edit_project ? 'edit_project' : 'add_project'; ?>" class="btn btn-primary">
                                                    <i class="fas fa-save"></i> Lưu
                                                </button>
                                                <a href="project.php" class="btn btn-secondary ml-2">
                                                ...
                                                <tbody>
                                                    <?php foreach ($projects as $project): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="?method=frm&edit_id=<?php echo $project['id']; ?>" class="btn btn-sm btn-warning" title="Sửa">
                                                                    <i class="fas fa-edit"></i> Sửa
                                                                </a>
                                                                <a href="?delete_id=<?php echo $project['id']; ?>" class="btn btn-sm btn-danger" title="Xóa" onclick="return confirm('Bạn có chắc muốn xóa?')">
